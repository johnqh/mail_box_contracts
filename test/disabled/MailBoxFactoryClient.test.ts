...
describe("MailBoxFactoryClient", function () {
  ...
  describe("Contract deployment", function () {
    ...
    it("Should deploy Mailer contract", async function () {
      ...
      const deployedAddress = await factoryClient.deployMailer(usdcAddress, owner.address, mailerSalt, walletClient, account);
    ...
    it("Should deploy MailService contract", async function () {
      ...
      const deployedAddress = await factoryClient.deployMailService(usdcAddress, owner.address, mailServiceSalt, walletClient, account);
    ...
    it("Should deploy both contracts in single transaction", async function () {
      ...
      const result = await factoryClient.deployBoth(usdcAddress, owner.address, mailerSalt, mailServiceSalt, walletClient, account);
  ...
  describe("Contract existence checking", function () {
    ...
    it("Should return true for deployed contracts", async function () {
      ...
      const deployedAddress = await factoryClient.deployMailer(usdcAddress, owner.address, salt, walletClient, account);
      expect(await factoryClient.isContractDeployed(deployedAddress)).to.be.true;
    });
  });
  ...
  describe("Integration with existing clients", function () {
    it("Should work with MailerClient and MailServiceClient", async function () {
      ...
      const mailerAddress = await factoryClient.deployMailer(usdcAddress, owner.address, salt, walletClient, account);
